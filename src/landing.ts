...
const SEED_NOTES: Array<{
  ...
  },
  {
    ...
    tags: "feature",
    description:
      "No passwords. Ever. Sign in with biometrics or a security key.",
  },
  {
    content: "REST API",
    color: "blue",
    ...
    tags: "feature",
    description:
      "Programmatic access to boards, notes, and users. Build integrations.",
  },
  ...
  },
  {
    ...
    tags: "feature,grp-keys",
    description:
      "h/j/k/l to navigate, x to delete, d to duplicate, c to cycle colors.",
  },
  ...
  },
  {
    ...
    tags: "usecase",
    description:
      "Attach screenshots. Leave feedback on cards. Visual and collaborative.",
  },
  {
    ...
    tags: "usecase",
    description:
      "What went well, what didn't, what to try next. One board, done.",
  },
  {
    content: "Mood boards",
    color: "pink",
    ...
    tags: "usecase",
    description:
      "Collect references, colors, and inspiration in one visual space.",
  },
  // Grouped: project management
  {
    ...
    tags: "usecase,grp-pm",
    description:
      "Track work across columns. To do, doing, done — or whatever you want.",
  },
  {
  ...
  {
    content: "Team standups",
    color: "pink",
    x: 0,
    y: 0,
    tags: "usecase,grp-daily",
    description:
      "Each person gets a note. Yesterday, today, blockers. Done in 5 minutes.",
  },
  {
    content: "Todo lists",
    color: "orange",
    ...
    tags: "usecase,grp-daily",
    description:
      "Quick personal boards. Checklists on each card. Check off and move on.",
  },
  ...
  {
    content: "Gets out of your way",
    color: "green",
    x: 0,
    y: 0,
    tags: "philosophy,grp-simple",
    description:
      "No onboarding. No tutorials. No 47 settings to configure. Just start.",
  },
  {
    content: "No bloat",
    color: "pink",
    ...
    tags: "philosophy,grp-simple",
    description:
      "No Gantt charts. No resource leveling. No enterprise pricing page.",
  },
];
